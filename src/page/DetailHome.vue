      ...
      <div>
        <div class="content">
          <div class="d-flex-column">
            <span class="title-content text-center" style="margin: 0 auto">ใบแจ้งชำระเงิน</span>
          ...
          <div class="text-center">
            <div>
              <div class="content-load">
                <img v-if="QrURL" v-bind:src="QrURL" alt="background" style="margin: 0 auto" width="90%" />
                <div v-else class="loader"></div>
              </div>
            </div>
            <button v-if="QrURL" @click="downloadImage" style="
