    ...
    <div class="page-body">
      ...
      <div class="pt-10 px-5">
        ...
        <div class="d-flex-column mt-3">
          <a @click="toDetail()"
            v-for="(item, index) in registerCodes"
            class="card-bg"
            :key="index"
          >
            <img
            ...
            <span class="content-card">
              <span class="title-card justify-content-end">{{
                item.LocationName
              }}</span>
              <span class="d-flex justify-content-end">
                ...
                <span class="detail-card">{{ item.RegisterCode }}</span>
              </span>
              <span class="d-flex mt-1">
                <span class="detail-card ml-0">{{ item.LocationName }}</span>
              </span>
            </span>
          </a>
        </div>
      ...
      <div class="pt-3 px-5">
        ...
        >
        <div class="d-flex-column mt-3">
          <a @click="toCoupon()" class="coupon-card">
            <div class="d-flex p-3">
              ...
              <div class="ml-12 my-auto">
                <span
                  class="title-card text-dark-75 font-600 font-size-h6 line-height-25"
                  >ส่วนลดมูลค่า 100 บาท</span
                >
                <span class="detail-card text-danger font-500 mx-0"
